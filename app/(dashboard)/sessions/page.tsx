...
import { Loader2, ArrowLeft, Edit, Play, BarChart, Trash2, CheckCircle } from "lucide-react"
...
export default function SessionDetailPage() {
  ...
  const updateSessionStatus = async (newStatus: string) => {
    ...
    try {
      ...
      toast.success(`Session ${getStatusActionText(newStatus)}`)
    } catch (error) {
    ...
    <div className="flex min-h-screen flex-col">
      <main className="flex-1 container py-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusBadgeClass(sessionData.status)}`}>
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-6">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem
                      onClick={() => updateSessionStatus("draft")}
                    ...
                    <DropdownMenuItem
                      ...
                      disabled={sessionData.status === "complete"}
                    >
                      Mark as Complete
                    </DropdownMenuItem>
                  </DropdownMenuContent>
              ...
              {sessionData.code && (
                <div className="flex justify-between">
                  ...
                  <span className="font-mono font-bold">{sessionData.code}</span>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <Button className="w-full justify-start" asChild disabled={sessionData.status === "complete"}>
              ...
              {sessionData.status !== "complete" && (
                <Button
                  ...
                  variant="outline"
                  onClick={() => updateSessionStatus("complete")}
                  disabled={isUpdatingStatus || sessionData.status === "complete"}
                >
